...
class LaunchPlugin : PluginBase
{
    ...
    private static void Browser_TitleChanged(object sender, DependencyPropertyChangedEventArgs e)
    {
        var browser = (ChromiumWebBrowser)sender;
        browser.Parent?.Dispatcher?.Invoke(() => ((Window)browser.Parent).Title = (string)e.NewValue);
    }
}
}